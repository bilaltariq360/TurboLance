  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center py-24">
        <div
          className="bg-gray-50 shadow-lg  rounded-lg px-8 pt-6 pb-8 mb-4 flex flex-col my-2 w-full md:w-3/4 lg:w-1/2"
          style={{ boxShadow: "0px 1px 100px 10px #4a5ea4fe" }}
        >
          <div
            className="flex border-b border-lighter py-4"
          ...
          <div
            className="flex border-t border-lighter py-4"
            style={{ borderColor: "black" }}
          >
        ...
        <h1 className="text-white text-3xl font-bold pt-20">
          Project Proposal
        </h1>
